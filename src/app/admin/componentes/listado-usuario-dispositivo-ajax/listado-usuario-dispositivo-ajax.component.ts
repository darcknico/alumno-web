...
@Component({
  selector: 'app-componentes-listado-usuario-dispositivo-ajax',
  templateUrl: './listado-usuario-dispositivo-ajax.component.html',
  styleUrls: ['./listado-usuario-dispositivo-ajax.component.scss']
})
export class ListadoUsuarioDispositivoAjaxComponent implements OnInit {
